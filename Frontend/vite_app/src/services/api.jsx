...
// New functions
export const deleteComment = (gameId, commentId) => apiRequest("DELETE", `/games/${gameId}/comments/${commentId}`);
export const deleteReply = (gameId, commentId, replyId) =>
  apiRequest("DELETE", `/games/${gameId}/comments/${commentId}/reply/${replyId}`);
