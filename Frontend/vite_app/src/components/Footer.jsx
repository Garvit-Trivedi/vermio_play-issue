    ...
    <footer className="bg-gray-900 text-white mt-25 py-8 px-4 md:px-16 lg:px-32">
      <div className="flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="text-center md:text-left">
          ...
          <div className="grid grid-cols-3 gap-4 mt-2 place-items-center text-blue-300">
          ...
          <div className="grid grid-cols-2 mt-2 text-center text-blue-300 place-items-center">
